    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
             ...
             <!-- Nav Item -Data Konversi Poin -->
             <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    <i class="bi bi-currency-dollar"></i>
                    <span>Data Konversi Poin</span></a>

            </li>

              <!-- Nav Item - Tukar Produk -->
              <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn " style="background-color: #79BA2A" type="button">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-white-600 small">Halo,{{ Auth::user()->name }}!</span>
                        ...
                        <div class="col-xl-12 col-lg-">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold" style="color: #32854D">Berat Sampah Berdasarkan Jenis</h6>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="vendor/sb-admin/img/undraw_posting_photo.svg" alt="...">
                                    </div>
