...
@section('content')
    <div class="p-md-3 p-auto my-4">
        ...
        <div class="text-center">
            <a href="{{ Route('konversi-poin') }}" class="btn btn-yellow rounded px-3 me-md-2 me-0 d-md-inline d-block">Konversi poin lagi</a>
